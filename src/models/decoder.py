...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(self, inputs, memory_bank, src_pad_mask, tgt_pad_mask,
        ...
        # print(memory_bank)
        # print("query_norm", query_norm.size())
        # print(query_norm)
        # print("src_pad_mask11111", src_pad_mask.size())
        # print(src_pad_mask)
...
class TransformerDecoder(nn.Module):
    ...
    def forward(self, tgt, memory_bank, state, memory_lengths=None,
                step=None, cache=None,memory_masks=None, need_y_emb = False):
        """
        ...
        if (not memory_masks is None):
            ...
            # print("memory_masks ", memory_masks.size())
            # print(memory_masks)
            # print("src_words ", src_words.data.size())
            # print(src_words.data)
            # print("padding_idx")
            # print(padding_idx)
